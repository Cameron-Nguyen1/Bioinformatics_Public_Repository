dep = c("optparse","methods","tidyverse","tximport","ensembldb","EnsDb.Hsapiens.v86","EnsDb.Mmusculus.v79","edgeR","matrixStats","cowplot","DT","plotly","gt","limma","GSEABase","Biobase","gprofiler2","clusterProfiler","msigdbr","pheatmap","enrichplot","IsoformSwitchAnalyzeR")
...
option_list = list(
  ...
  make_option(c("--install"), type="character", default=NULL,
              help="Directs output to designated directory.", metavar="character")
)
lapply(dep,library,character.only=TRUE)
